    ...
    try {
        ...
        if (typeof initSqlJs === 'undefined') {
            ...
            if (typeof showNotification === 'function') {
                showNotification('Помилка: SQL.js не завантажено. Перезавантажте сторінку або вимкніть локальну БД.', 'error');
            }
            return false;
        }
        
        SQL = await initSqlJs({
            // Використовуємо unpkg, який вже дозволений у CSP (connect-src)
